...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public void shootTheBall() {
    // TODO: When the indexer exists, engage it here if isAtTargetRpm() is true.
    if (isAtTargetRpm()) {
      readyShotCount++;
      // TODO: When the indexer exists, this is where you'd actually feed the ball.
      return;
    }
  ...
  public int getReadyShotCount() {
    return readyShotCount;
  }
  ...
  public void periodic() {
    ...
    if (autoShootRequested && isAtTargetRpm()) {
      ...
      readyShotCount++;
      // TODO: When the indexer exists, feed the ball here for auto-shoot.
    }
