...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    operator.leftBumper().onTrue(Commands.runOnce(shooter::requestAutoShoot, shooter));
    ...
    new JoystickButton(trellis, 5).onTrue(Commands.runOnce(shooter::requestAutoShoot, shooter));
